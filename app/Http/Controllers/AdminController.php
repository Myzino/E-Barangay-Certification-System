...
class AdminController extends Controller
{
    ...
    public function Profile() {
        ...
        return view('admin_profile_view',compact('profileData')); //passing through compact method
    }
    ...
    //jeffrey request
    public function ProfileStore(Request $request) {  //post request to update profile
