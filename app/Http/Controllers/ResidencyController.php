...
class ResidencyController extends Controller
{
    public function index() {
        $residencies = Residency::all();  //Fetch all residents from the database
        return view('app.residency.index', ['residencies' => $residencies]);
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('residency.index')->with($notification);
    ...
    {
        $resident = Residency::findOrFail($id);
        $resident->delete();
